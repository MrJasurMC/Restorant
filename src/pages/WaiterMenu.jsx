        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <form onSubmit={handlePlaceOrder} className="space-y-4">
              ...
              {}
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Buyurtma turi</label>
        ...
        <div className="max-w-5xl mx-auto px-4 py-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">{tableNumber}-stol · <span className="text-orange-500 font-medium">{waiterSession?.name}</span></p>
            </div>
